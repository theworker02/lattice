...
The mirrored-facet symbol is the official LATTICE mark. It represents multiple reflective surfaces behaving as one physical computing system.

| Asset | Use |
| --- | --- |
| `lattice-mark.svg` | Default app, hardware, social and package mark |
...
- Keep the mark upright and preserve its surrounding empty space.
- Use the full-color mark on dark or neutral surfaces when possible.
- Use the monochrome mark only where one-color reproduction is required.
